#!/usr/bin/env python3
"""Deploy contracts/redteam_court.py to GenLayer StudioNet and record the
...
- refuses to deploy unless contracts/redteam_court.py is committed and
...
CONTRACT_PATH = "contracts/redteam_court.py"
        ...
        try:
            request = urllib.request.Request(
                RPC, data=body, headers={"Content-Type": "application/json",
                                         "User-Agent": "redteam-court-deploy"})
